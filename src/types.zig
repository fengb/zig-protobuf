...
fn FromBitCast(comptime TargetPrimitive: type, comptime Coder: type, comptime info: FieldMeta) type {
    return struct {
        ...
        pub fn encodeInto(self: Self, comptime OutStream: type, out_stream: *OutStream) !void {
            try Coder.encodeInto(OutStream, out_stream, @bitCast(Coder.primitive, self.value));
        }
...
fn FromVarintCast(comptime TargetPrimitive: type, comptime Coder: type, comptime info: FieldMeta) type {
    return struct {
        ...
        pub fn encodeInto(self: Self, comptime OutStream: type, out_stream: *OutStream) !void {
            try Coder.encodeInto(OutStream, out_stream, self.value);
        }
...
pub fn Bytes(comptime number: u63) type {
    return struct {
        ...
        pub fn encodeInto(self: Self, comptime OutStream: type, out_stream: *OutStream) !void {
            try coder.BytesCoder.encodeInto(OutStream, out_stream, self.value);
        }
...
pub fn Bool(comptime number: u63) type {
    return struct {
        ...
        pub fn encodeInto(self: Self, comptime OutStream: type, out_stream: *OutStream) !void {
            const value = if (self.value) [_]u8{1} else [_]u8{0};
